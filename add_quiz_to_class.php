                                ...
                                <div class="span12">
									...
									<a href="teacher_quiz.php" class="btn btn-info"><i class="icon-arrow-left"></i> Back</a>
										...
										<div class="control-group">
											...
											<select name="quiz_id">
											<option></option>
												<?php  $query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from quiz where teacher_id = '$session_id'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
				...
				<tbody>
					...
					<?php } ?>
										...
										if (isset($_POST['save'])){
											...
											for($i=0; $i < $N; $i++)
											{
												mysqli_query($GLOBALS["___mysqli_ston"], "insert into class_quiz (teacher_class_id,quiz_time,quiz_id) values('$id[$i]','$time','$quiz_id')")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
												mysqli_query($GLOBALS["___mysqli_ston"], "insert into notification (teacher_class_id,notification,date_of_notification,link) value('$id[$i]','$name_notification',NOW(),'student_quiz_list.php')")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
											} ?>
											<script>
