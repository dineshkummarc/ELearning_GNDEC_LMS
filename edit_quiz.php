                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<?php
								$query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from quiz where quiz_id = '$get_id'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
								...
								?>
										...
										mysqli_query($GLOBALS["___mysqli_ston"], "update quiz set quiz_title = '$quiz_title',quiz_description = '$description' where quiz_id = '$quiz_id'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
										?>
										<script>
