                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<?php include('modal_delete_quiz.php'); ?>
										...
										<tbody>
                              		<?php
										$query = mysqli_query($GLOBALS["___mysqli_ston"], "select * FROM quiz where teacher_id = '$session_id'  order by date_added DESC ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
