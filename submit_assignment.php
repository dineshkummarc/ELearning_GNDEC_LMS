            ...
            <div class="row-fluid">
					   ...
					   <!-- breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									<?php
										$query1 = mysqli_query($GLOBALS["___mysqli_ston"], "select * FROM assignment where assignment_id = '$post_id'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
				...
				<table cellpadding="0" cellspacing="0" border="0" class="table" id="">
                              		...
                              		<?php
										...
										where assignment_id = '$post_id'  order by assignment_fdatein DESC")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
