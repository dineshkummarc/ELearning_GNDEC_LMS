                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
							...
							<div class="pull-right">
								...
								<?php
								$query_backpack = mysqli_query($GLOBALS["___mysqli_ston"], "select * FROM student_backpack where student_id = '$session_id'  order by fdatein DESC ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
								...
								?>
									...
									<?php include('modal_backpack_delete.php'); ?>
										...
										<tbody>
                              		<?php
										$query = mysqli_query($GLOBALS["___mysqli_ston"], "select * FROM student_backpack where student_id = '$session_id'  order by fdatein DESC ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
