                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                              		...
                              		<?php
										$query = mysqli_query($GLOBALS["___mysqli_ston"], "select * FROM student_assignment 
										...
										order by fdatein DESC")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<table cellpadding="0" cellspacing="0" border="0" class="table" id="">
										...
										<tbody>
                              		<?php
										$query = mysqli_query($GLOBALS["___mysqli_ston"], "select * FROM class_quiz 
										LEFT JOIN quiz on class_quiz.quiz_id = quiz.quiz_id
										where teacher_class_id = '$get_id' order by class_quiz_id DESC ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
										while($row = mysqli_fetch_array($query)){
										$id  = $row['class_quiz_id'];
										$quiz_id  = $row['quiz_id'];
										$quiz_time  = $row['quiz_time'];
									
										$query1 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from student_class_quiz where class_quiz_id = '$id' and student_id = '$session_id'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
