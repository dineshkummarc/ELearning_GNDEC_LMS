					   ...
					   <!-- breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								<?php $query = mysqli_query($GLOBALS["___mysqli_ston"], "select * FROM assignment where class_id = '$get_id'  order by fdatein DESC")or die(mysqli_error($GLOBALS["___mysqli_ston"])); 
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<?php
									$query = mysqli_query($GLOBALS["___mysqli_ston"], "select * FROM assignment where class_id = '$get_id'  order by fdatein DESC")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
									$count = mysqli_num_rows($query);
									if ($count == '0'){?>
