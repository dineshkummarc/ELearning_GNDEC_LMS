                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<a href="teacher_quiz.php" class="btn btn-info"><i class="icon-arrow-left"></i> Back</a>
										...
										mysqli_query($GLOBALS["___mysqli_ston"], "insert into quiz (quiz_title,quiz_description,date_added,teacher_id) values('$quiz_title','$description',NOW(),'$session_id')")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
										?>
										<script>
