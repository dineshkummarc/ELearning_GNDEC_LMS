...
<?php $query1 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from student_class_quiz where student_id = '$session_id' and class_quiz_id = '$class_quiz_id' ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
...
if ($count > 0){
 ...
 mysqli_query($GLOBALS["___mysqli_ston"], "insert into student_class_quiz (class_quiz_id,student_id,student_quiz_time) values('$class_quiz_id','$session_id','$quiz_time')");
}
 ?>
...
$sqlp = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM class_quiz WHERE class_quiz_id = '$class_quiz_id'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
...
<?php
										$sqla = mysqli_query($GLOBALS["___mysqli_ston"], "select * FROM class_quiz 
										LEFT JOIN quiz ON quiz.quiz_id  = class_quiz.quiz_id
										where teacher_class_id = '$get_id' 
										order by date_added DESC ")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
...
<?php
	$sqlw = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM quiz_question where quiz_id = '$quiz_id'  ORDER BY RAND()");
...
<?php
	...
	$sqly = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM answer WHERE quiz_question_id = '".$roww['quiz_question_id']."'");
...
<?php
	...
	for($x=1;$x<=$x1;$x++){
		...
		$sql = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM quiz_question WHERE quiz_question_id = ".$x2."");
	...
	mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE student_class_quiz SET `student_quiz_time` = 3600, `grade` = '".$score." out of ".($x-1)."' WHERE student_id = '$session_id' and class_quiz_id = '$class_quiz_id'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
?>
<script>
